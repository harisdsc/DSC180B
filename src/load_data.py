...
CONS_PATH = "data/consumers.pqt"
ACCT_PATH = "data/accounts.pqt"
TRXN_PATH = "data/transactions.pqt"
...
def load_data():
    ...
    trxnDF = trxnDF[trxnDF['posted_date'] <= trxnDF['evaluation_date']]
    ...
    acctDF = acctDF[acctDF['balance_date'] <= acctDF['evaluation_date']]
